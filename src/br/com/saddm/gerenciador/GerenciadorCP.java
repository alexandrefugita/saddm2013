...
public class GerenciadorCP {
	...
	public void gerarChaves(String pass, String passAle) {
		...
		try {
			...
			KeyPair pair = keyGen.generateKeyPair(); // Por seguran�a destruir o random depois de gerar as chaves
	...
	// Metodo de Verifica��o de assinatura
	public boolean verifica (String fileSelected, String signature, String pubKey) {
		...
		try {
            ...
            boolean verifies = sig.verify(sigToVerify);
             System.out.println("Verifica��o da Assinatura = " + verifies );
            return verifies;
		} catch(Exception e) {
			e.printStackTrace();
		}
