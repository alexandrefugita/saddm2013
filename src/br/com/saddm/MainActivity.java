...
import br.com.saddm.gerenciador.GerenciadorCadastro;
import br.com.saddm.gerenciador.GerenciadorDestinatario;
import br.com.saddm.gerenciador.GerenciadorGeracaoChavePub;
import br.com.saddm.gerenciador.GerenciadorPrincipal;
import br.com.saddm.gerenciador.SendFile;
import br.com.saddm.gerenciador.Signer;
import br.com.saddm.gerenciador.Verify;
...
public class MainActivity extends Activity {
	...
	public void chavePub(View view) {
		Intent intent = new Intent(MainActivity.this, GerenciadorGeracaoChavePub.class);
	    startActivity(intent);
	}
	...
	public void receiveFile(View view) {
		Intent intent = new Intent(MainActivity.this, GerenciadorDestinatario.class);
	    startActivity(intent);
	}
}
